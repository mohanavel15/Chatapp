    ...
    return (
        <div className="profile-bar">
            ...
            <div className="profile-bar-settings">
                <button id="profile-bar-mic" className="profile-bar-button" onClick={() => { call_ctx.setMute(!call_ctx.Mute) }}> 
                ...
                <button id="profile-bar-headset" className="profile-bar-button" onClick={() => { call_ctx.setDeafen(!call_ctx.Deafen) }}> 
