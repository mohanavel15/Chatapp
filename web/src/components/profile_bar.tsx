    ...
    return (
        <div className="profile-bar">
            ...
            <div className="profile-bar-settings">
                <button id="profile-bar-mic" className="profile-bar-button" onClick={() => { state_context.setMute(!state_context.Mute) }}> 
                ...
                <button id="profile-bar-headset" className="profile-bar-button" onClick={() => { state_context.setDeafen(!state_context.Deafen) }}> 
